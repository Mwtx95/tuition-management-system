...
from .views import (
    ...
    PublicClassResultSheetView,
    ClassResultView,
    ClassResultSheetView,
    ClassRoomViewSet,
    ExamViewSet,
    PublishExamView,
    PublishStudentResultView,
    ReportCardPdfView,
    ResultBulkUploadView,
    ResultUploadView,
    SubjectResultSheetView,
    StudentResultView,
    StudentViewSet,
    SubjectViewSet,
)
...
urlpatterns = [
    ...
    path(
        "results/class/<int:class_id>/sheet/public/",
        PublicClassResultSheetView.as_view(),
        name="public-class-result-sheet",
    ),
    path(
    ...
    path(
        "results/subject/<int:subject_id>/sheet/",
        SubjectResultSheetView.as_view(),
        name="subject-result-sheet",
    ),
    path("exams/<int:exam_id>/publish/", PublishExamView.as_view(), name="publish-exam"),
    path(
        "exams/<int:exam_id>/publish-student/<int:student_id>/",
        PublishStudentResultView.as_view(),
        name="publish-student-result",
    ),
    path(
